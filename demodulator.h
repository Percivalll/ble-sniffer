...
public:
    ...
    int setBuffer(DataBuffer *bufffer);
public Q_SLOTS:
    int startDemod();
    int stopDemod(){mRunFlag=false;return 0;};
private:
    int mSampleRate;
    bool mRunFlag;
    DataBuffer *mSamplesBuffer;
    const uint8_t mScrambleTableCh37[42] = {
    ...
    const uint_fast32_t mCRCTable[256] = {
